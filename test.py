...
train_ds = tf.data.Dataset.from_generator(FrameGenerator(subset_paths['train_master'], n_frames, augmentation=False, training=False, frame_step=1),
                                          output_signature=output_signature)

train_ds_2 = tf.data.Dataset.from_generator(FrameGenerator(subset_paths['train_master'], n_frames, augmentation=False,  training=False, frame_step=52),
                                          output_signature=output_signature)
...
for i in range(1000):
    frames, label = next(train_gen())
    frames_2, label_2 = next(train_gen16())
